...
public class GeofenceReceiverService extends BroadcastReceiver
        implements
    ...
    public void onConnectionSuspended(int i) {
        Log.i(getClass().getSimpleName(),"Geofence connection suspended");
    }

    @Override
    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        Log.i(getClass().getSimpleName(),"Geofence connection failed");
    ...
    public void onResult(@NonNull Status status) {
        if (status.isSuccess()) {
            ...
            Log.i(getClass().getSimpleName(),Integer.toString(status.getStatusCode()));
        }
    }
